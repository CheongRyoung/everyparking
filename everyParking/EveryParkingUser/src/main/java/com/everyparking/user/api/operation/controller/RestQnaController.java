...
//	public ModelAndView deleteQna(HttpServletRequest request, @RequestBody HashMap<String,Object> params) throws Exception{
//		ModelAndView mav = super.createMav();
//		try {
//			SessionUtil.setCreator(request, params);
//			mav = super.createMav(qnaservice.deleteQna(params));
//			super.setMessage(mav, Ajax.DELETE.TEXT+"."+ Ajax.TPYE_SUCCESS);
//		} catch (Exception e) {
//			logger.error(e.getMessage());
//			super.setMessage(mav, Ajax.DELETE.TEXT+"."+Ajax.TPYE_FAIL);
//		}
//		return mav;
//	}
