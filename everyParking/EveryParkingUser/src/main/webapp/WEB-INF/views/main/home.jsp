    ...
    <main>
        ...
        <div class="row m-0">
            <div class="col mt-5 mx-2 pt-5 ps-0">
                ...
                <p style="font-size: 1.5rem; font-weight: bold;">바로 <span style="color: #2c0eee; font-size: 2.2rem;">우주</span>에서 확인하세요</p>
                <div class="row my-5">
                    <div class="col mx-2">
                        <form action="/main/map" method="post" onclick="DaumPostcode();">
                            <div class="input-group">
                                ...
                                <button class="input-group-text" style="border: 0px; background-color: #2c0eee;"><i class="bi bi-search text-white"></i></button>
                            </div>
