            ...
            <div class="col">
                ...
                <div class="row my-4">
	                ...
	                <c:if test="${!empty move.NOTI_NEXT}">                
	                    <a href="./content?NOTI_SEQ=${move.NOTI_NEXT}"><button class="insertBtn btn btn-outline-primary">이전글</button></a>
	                </c:if>    
	                <c:if test="${!empty move.NOTI_PREV}">
	                    <a href="./content?NOTI_SEQ=${move.NOTI_PREV}"><button class="insertBtn btn btn-outline-primary">다음글</button></a>
	                </c:if>
                    </div>
                </div>
