package com.everyparking.admin.test.controller;
...
import com.everyparking.admin.test.service.TestService;
import com.everyparking.admin.util.CreateUploadFolderUtil;
import com.everyparking.admin.util.ExcelDounloadUtil;
...
public class TestController {
	...
	public void excelDownload(HttpServletResponse response) {
		...
		ExcelDounloadUtil excelDounloadUtil = new ExcelDounloadUtil(
				test.getDBTest(), 
				"테스트시트명",
				"test파일명123!@#_");
		// ExcelDounloadUtil 객체의 excelDownload메소드를 사용 응답을 해줘야 되니 response 꼭 필요
		excelDounloadUtil.excelDownload(response);
	}
