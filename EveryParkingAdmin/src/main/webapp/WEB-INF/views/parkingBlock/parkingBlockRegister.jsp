			...
			<div class="row mt-3">
				...
				<div class="col ms-1">
					...
					<div class="row me-3 mt-3">
						...
						<div class="col">
							<form>
								<textarea row="5" col="50" class="inputPlusSelectBox"
									style="width: 100%; height: 150px; border-radius: 0.25rem; border: 1px solid #ced4ce"
									placeholder="이용 불가된 사유를 작성해주세요"></textarea>
							</form>
						</div>
					</div>
